...
import anotation.custom.annotation.ModelDescriptionPrint;
import anotation.custom.annotation.ModelDescriptionPrints;
...
public class Car {
    ...
    @ModelDescriptionPrints({
            @ModelDescriptionPrint(model = "Sonata", description = "stredy seller"),
